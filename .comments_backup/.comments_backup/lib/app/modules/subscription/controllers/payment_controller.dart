...
class PaymentController extends GetxController {
  ...
  Future<void> handleFreeSelection() async {
    try {
      ...
      // No backend call for free; set userType locally then refresh.
  ...
  Future<void> initiatePaidFlow(SubscriptionPlan plan) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Give the dialog dismissal a short moment so navigation isn't
        // blocked by the closing animation / route changes.
        await Future.delayed(const Duration(milliseconds: 200));

        // If the backend returned a URL without scheme, try to prefix it.
        ...
        if (result == true) {
          // Payment success: patch user_type
          ...
          try {
            ...
            if (patchResp.statusCode == 200 || patchResp.statusCode == 201) {
              ...
              // Update locally first so UI gating reacts immediately,

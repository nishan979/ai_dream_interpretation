...
class AuthController extends GetxController {
  ...
  //     Get.offAllNamed('/home');
  //     Get.snackbar('Success', 'Successfully signed in as ${googleUser.displayName}!');
  ...
  Future<void> signInWithGoogle() async {
    try {
      ...
      // TODO: Here you would typically send the googleUser.idToken to your backend
      // to exchange it for your own app's tokens. For now, we'll just log in.
      Get.back();
      userType.value = 'free';
      Get.offAllNamed('/home');
      Get.snackbar(
  ...
  Future<void> signOut() async {
    try {
      ...
      await _auth.signOut();
      await _storage.deleteAll(); // Clear stored tokens
